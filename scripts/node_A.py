...
# node_A se encarga de inicializar el nodo, crear los objetos publicadores y subscriptores; y también de publicar las variables bool, int y float recibidas
def node_A():
